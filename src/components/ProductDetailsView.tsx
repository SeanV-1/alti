...
const DETAIL_CATALOG = [
  {
    ...
    colorAccent: "#c0605a",
    imageUrl: "/images/product2-details-img.png",
    // Gradient: deep navy top → coral-pink bottom
    gradientFrom: "#0f1c2e",
    gradientMid: "#1e2d42",
    gradientTo: "#c05a50",
    leftPhoto: "/images/product2-details-img2.png",
    rightPhoto: "/images/product2-details-img3.png",
  },
  {
    id: "rosemary",
    ...
    activeIngredients: ["L-Theanine", "Magnesium", "Lion's Mane"],
    colorAccent: "#c07840",
    imageUrl: "/images/product-detail-img1.PNG",
    gradientFrom: "#0d1e14",
    gradientMid: "#1b2e1e",
    gradientTo: "#a06030",
    leftPhoto: "/images/product-details-img2.PNG",
    rightPhoto: "/images/product-details-img3.png",
  },
  {
    id: "lilikoi",
    ...
    activeIngredients: ["L-Theanine", "Magnesium", "Lion's Mane"],
    colorAccent: "#c04060",
    imageUrl: "/images/product3-details-img.png",
    gradientFrom: "#1a0e1e",
    gradientMid: "#2a1430",
    gradientTo: "#b03060",
    leftPhoto: "/images/product3-details-img2.png",
    rightPhoto: "/images/product3-details-img3.png",
  },
];
